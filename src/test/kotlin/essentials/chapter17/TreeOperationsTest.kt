...
import essentials.chapter17.TreeOperations.Leaf
import essentials.chapter17.TreeOperations.Node
import essentials.chapter17.TreeOperations.biggest
import essentials.chapter17.TreeOperations.contains
import essentials.chapter17.TreeOperations.count
import essentials.chapter17.TreeOperations.countAll
import essentials.chapter17.TreeOperations.height
import essentials.chapter17.TreeOperations.sum
...
class TreeOperationsTest {
    ...
    /*
        ...
        5      3
     */
    private val treeInt = Node(Node(Node(Leaf(5), Leaf(3)), Leaf(4)), Leaf(3))
